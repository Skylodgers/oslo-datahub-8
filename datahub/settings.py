...
DATATYPE_LOCATIONS.append('datahub.datatypes')
FUNCTION_LOCATIONS.append('datahub.functions')
ETL_MODULE_LOCATIONS.append('datahub.etl_modules')
SEARCH_COMPONENT_LOCATIONS.append('datahub.search_components')
...
SECRET_KEY = 'django-insecure-=5n2k&hr^^g-lvu-ab3eaezu&g%qaumcq#12w-pczmawgr3fu+'
...
ELASTICSEARCH_PREFIX = 'datahub'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'datahub.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    "pgtrigger",
    # "silk",
    "datahub",  # Ensure the project is listed before any other arches applications
)
...
# ES_MAPPING_MODIFIER_CLASSES = ["datahub.search.es_mapping_modifier.EsMappingModifier"]
